...
#
# Description:
#     Disable Connect-Disconnect (CD) Stress operation on the DUT device
...
class CDstressOFFController:
    """
    Controller class to disable Connect-Disconnect (CD) Stress.

    This class locates the USB DUT device using Vendor ID and
    Product ID, and sends a control transfer command to disable
    CD stress operation.
    ...
    def __init__(self, vendor_id, product_id):
        """
        Initialize CD Stress OFF controller.
    ...
    def set_cdstress_off(self):
        """
        Send control transfer command to disable CD Stress.
    ...
    def setup_cd_stress_off(self):
        """
        Complete workflow to disable CD Stress.

        This function finds the device and sends the
        CD Stress OFF command.
